...
const Hero = () => {
  return (
    <div id='inicio' className='w-full mx-auto pt-[100px]'>
        ...
        <div className='md:flex md:w-[80%] w-full justify-center mx-auto md:mx-auto pb-4 '>
            ...
            <div id='habilidades' className='text-white w-[90%] mt-4 h-full mx-auto items-center md:my-auto  bg-slate-700/80 drop-shadow-lg shadow-lg shadow-blue-500/50'>
