    ...
    <div id='habilidades' className='w-full mx-auto pt-[100px]'>
        ...
        <div className='md:flex md:w-[80%] w-full justify-center mx-auto md:mx-auto pb-4 '>
            ...
            <div className='flex w-[90%] h-full gap-4 justify-center mx-auto md:justify-end md:flex-row-reverse'>
                ...
                <div className='flex flex-col  bg-[#0c2c27] drop-shadow-lg gap-4 my-auto h-full items-center p-3 shadow-lg shadow-black'>
            ...
            <div className='text-white w-[90%] mt-8 h-full mx-auto items-center md:my-auto  bg-[#0c2c27] drop-shadow-lg shadow-lg shadow-black'>
